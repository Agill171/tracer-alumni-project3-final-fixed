...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get(
        'alumni/import/excel',
        [AlumniController::class, 'importForm']
    )->name('alumni.import.form');

    Route::post(
        'alumni/import/excel',
        [AlumniController::class, 'importExcel']
    )->name('alumni.import.excel');

    Route::get(
        'alumni/export/excel',
        [AlumniController::class, 'exportExcel']
    ...
    Route::get(
        ...
        [HasilPelacakanController::class, 'create']
    )->name('pelacakan.create');

    Route::post(
        'alumni/{alumni}/pelacakan',
        [HasilPelacakanController::class, 'store']
    )->name('pelacakan.store');

    Route::get(
        'pelacakan/{pelacakan}/edit',
        [HasilPelacakanController::class, 'edit']
    )->name('pelacakan.edit');

    Route::put(
        'pelacakan/{pelacakan}',
        [HasilPelacakanController::class, 'update']
    )->name('pelacakan.update');

    Route::delete(
        'pelacakan/{pelacakan}',
        [HasilPelacakanController::class, 'destroy']
