<x-layouts.app-tracer>
    ...
    <div class="mb-8">
        ...
        <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
            ...
            <a
                href="{{ route('pelacakan-batches.index') }}"
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 mb-8">
        ...
        <div class="mt-5 rounded-xl border border-amber-200 bg-amber-50 p-4">
            ...
            <p class="text-sm text-amber-800">
                ...
                <strong>
                    Query Siap ≠ data ditemukan.
                </strong>

                Coverage Project 4 hanya meningkat setelah evidence
                benar-benar terverifikasi dan minimal satu kategori
                Project 4 terisi pada alumni.
    ...
    @php
        ...
        $enrichmentRunning =
            $batch->status ===
            \App\Models\PelacakanBatch::STATUS_ENRICHMENT;
        ...
        $enrichmentCompleted =
            ...
            && (int) (
                $batch->enrichment_processed_items
                ?? 0
            )
        ...
        <div class="flex flex-col xl:flex-row xl:items-start xl:justify-between gap-6">
            ...
            <div class="max-w-3xl">
                ...
                <p class="text-sm text-slate-600 mt-2">
                    ...
                    Sistem mengambil query alumni yang sudah disiapkan,
                    menjalankan pencarian melalui Tavily Search API,
                    mencocokkan identitas kandidat, kemudian
                    mengelompokkan hasil menjadi Teridentifikasi,
                    Perlu Verifikasi, Tidak Ditemukan, atau Gagal.
            ...
            <div class="shrink-0">
                ...
                @if(!$enrichmentEnabled)
                    ...
                    <button
                        type="button"
                        disabled
                        class="px-5 py-3 rounded-xl bg-slate-300 text-slate-600 font-semibold cursor-not-allowed">
                    ...
                    <p class="text-xs text-red-600 mt-2 max-w-xs">
                        AUTO_ENRICHMENT_ENABLED masih false.
                    </p>
                ...
                @elseif($enrichmentCompleted)
                    ...
                    <button
                        type="button"
                        disabled
                        class="px-5 py-3 rounded-xl bg-emerald-100 text-emerald-700 font-semibold cursor-not-allowed">
                    ...
                    <p class="text-xs text-emerald-600 mt-2 max-w-xs">

                        Semua item pada batch ini sudah diproses.
                ...
                @elseif($enrichmentRunning)
                    ...
                    <button
                        type="button"
                        disabled
                        class="px-5 py-3 rounded-xl bg-blue-100 text-blue-700 font-semibold cursor-not-allowed">
                ...
                @else
                    ...
                    <form
                        ...
                        onsubmit="return confirm(
                            'Mulai Auto Enrichment untuk batch ini? Tavily API credits akan digunakan.'
                        );">
                        ...
                        <button
                            type="submit"
                            class="px-5 py-3 rounded-xl bg-violet-600 hover:bg-violet-700 text-white font-semibold shadow-sm">
                    ...
                    <p class="text-xs text-slate-500 mt-2 max-w-xs">
                        ...
                        Setelah ditekan, jalankan queue worker
                        khusus local-enrichment.
            ...
            <div class="grid md:grid-cols-2 gap-3 mt-4 text-sm text-slate-500">
                ...
                <p>
                    ...
                    <strong class="text-slate-700">
                        ...
                        {{ $batch->enrichment_started_at?->format(
                            'd-m-Y H:i:s'
                        ) ?? '-' }}
                ...
                <p>
                    ...
                    <strong class="text-slate-700">
                        ...
                        {{ $batch->enrichment_finished_at?->format(
                            'd-m-Y H:i:s'
                        ) ?? '-' }}
    ...
    <div class="space-y-6">
        ...
        @forelse($items as $item)
            ...
            @php
                ...
                /*
                 * Social media alumni dihitung satu kategori.
                 */
                $socialMediaAda =
                ...
                $statusClass =
                    match($item->status) {
                        ...
                        \App\Models\PelacakanBatchItem::STATUS_QUERY_SIAP =>
                            'bg-violet-100 text-violet-700',

                        \App\Models\PelacakanBatchItem::STATUS_SELESAI =>
                            'bg-emerald-100 text-emerald-700',

                        \App\Models\PelacakanBatchItem::STATUS_DIPROSES =>
                            'bg-blue-100 text-blue-700',

                        \App\Models\PelacakanBatchItem::STATUS_GAGAL =>
                ...
                $enrichmentClass =
                    match(
                        ...
                        \App\Models\PelacakanBatchItem::ENRICHMENT_DIPROSES =>
                            'bg-blue-100 text-blue-700',

                        \App\Models\PelacakanBatchItem::ENRICHMENT_TERIDENTIFIKASI =>
                            'bg-emerald-100 text-emerald-700',

                        \App\Models\PelacakanBatchItem::ENRICHMENT_PERLU_VERIFIKASI =>
                            'bg-amber-100 text-amber-700',

                        \App\Models\PelacakanBatchItem::ENRICHMENT_TIDAK_DITEMUKAN =>
                            'bg-slate-200 text-slate-700',

                        \App\Models\PelacakanBatchItem::ENRICHMENT_GAGAL =>
                            'bg-red-100 text-red-700',

                        \App\Models\PelacakanBatchItem::ENRICHMENT_MENUNGGU =>
            ...
            <article class="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap items-center gap-3">
                            ...
                            @if($item->enrichment_status)
                                ...
                                <span class="px-3 py-1 rounded-full text-sm font-medium {{ $enrichmentClass }}">
                ...
                <div class="mt-5">
                                        ...
                                        <tr class="border-b border-slate-200">
                                            ...
                                            <td class="p-3">
                                                ...
                                                <a
                                                    ...
                                                    class="inline-flex px-3 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-medium">
                    ...
                    @else
                        ...
                        <div class="rounded-xl bg-slate-50 border border-slate-200 p-4 text-slate-500">

                            Query belum tersedia.
        ...
        @empty
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center text-slate-600">

                Batch ini belum mempunyai item.
